...
struct UBP_ActionCooking_C_ExecuteUbergraph_BP_ActionCooking_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3D62[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class ABP_CookingFryingPan_C*                CallFunc_FinishSpawningActor_ReturnValue;          // 0x98(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                   K2Node_DynamicCast_AsPal_Player_Character;         // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
