...
{
public:
	uint8                                        Pad_E68[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E75[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E7A[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E7C[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EB3[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
