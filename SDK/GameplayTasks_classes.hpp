...
{
public:
	uint8                                        Pad_2594[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_259B[0x25];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_25BA[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_25E3[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_1A6 : 1;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_26B2[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_26D1[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
