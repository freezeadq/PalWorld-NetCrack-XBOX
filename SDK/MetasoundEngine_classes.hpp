...
public:
	...
	uint8                                        Pad_1F87[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F92[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FA2[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FA7[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1FAD[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
