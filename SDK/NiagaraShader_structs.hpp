...
{
public:
	uint8                                        Pad_899[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_8A8[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8A9[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_8B3[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
