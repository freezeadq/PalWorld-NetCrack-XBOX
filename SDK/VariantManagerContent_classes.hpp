...
public:
	...
	uint8                                        Pad_1B1A[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B33[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B3C[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B40[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B41[0x77];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B51[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B52[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B92[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
