...
struct UBP_Status_UNKOTimer_C_ExecuteUbergraph_BP_Status_UNKOTimer_Params
{
public:
	...
	float                                        CallFunc_K2_SetTimerDelegate_InitialStartDelayVariance_ImplicitCast; // 0x70(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
