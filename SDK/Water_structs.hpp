...
public:
	...
	uint8                                        Pad_98D[0x1AB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_98E[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9A1[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9BF[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9F9[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9FC[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
