...
struct UBP_NPCActionStepBase_C_GetStepEndLocation_Params
{
public:
...
struct UBP_NPCActionStepBase_C_StepMove_Params
{
public:
	...
	struct FVector                               CallFunc_VLerp_ReturnValue;                        // 0x28(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_VLerp_Alpha_ImplicitCast;                 // 0x12C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x2D2 (0x2D2 - 0x0)
// Function BP_NPCActionStepBase.BP_NPCActionStepBase_C.CheckFrontHight
struct UBP_NPCActionStepBase_C_CheckFrontHight_Params
{
public:
...
struct UBP_NPCActionStepBase_C_DisableMovement_Params
{
public:
...
struct UBP_NPCActionStepBase_C_TickAction_Params
{
public:
...
struct UBP_NPCActionStepBase_C_ExecuteUbergraph_BP_NPCActionStepBase_Params
{
public:
	...
	class UPalCharacterMovementComponent*        CallFunc_GetComponentByClass_ReturnValue_1;        // 0x50(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetStepEndLocation_Location;              // 0xA8(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_7;         // 0xC0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalSkeletalMeshComponent*             CallFunc_GetMainMesh_ReturnValue;                  // 0xC8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                     CallFunc_SpawnSystemAttached_ReturnValue;          // 0xD0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_1;  // 0x104(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
