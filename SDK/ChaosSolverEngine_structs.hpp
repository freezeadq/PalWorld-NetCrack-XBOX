...
{
public:
	uint8                                        Pad_237F[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2388[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_238A[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
