...
struct UBP_AlertByKilledFriendState_QuestionMark_C_ExecuteUbergraph_BP_AlertByKilledFriendState_QuestionMark_Params
{
public:
	...
	class UObject*                               CallFunc_GetOuterObject_ReturnValue_1;             // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalAIActionBase*                      K2Node_DynamicCast_AsPal_AIAction_Base;            // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalActionBase*                        CallFunc_PlayAction_ReturnValue;                   // 0x38(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
