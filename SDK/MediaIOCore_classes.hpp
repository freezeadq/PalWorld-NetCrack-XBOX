...
public:
	...
	uint8                                        Pad_8B[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8C[0xD8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8D[0x68];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_99[0xB];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9A[0x8];                                       // Fixing Size Of Struct [ Dumper-7 ]
