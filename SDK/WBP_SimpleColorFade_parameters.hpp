...
struct UWBP_SimpleColorFade_C_ToggleVisibility_Params
{
public:
...
struct UWBP_SimpleColorFade_C_ExecuteUbergraph_WBP_SimpleColorFade_Params
{
public:
	...
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x2A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1715[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_EqualEqual_DoubleDouble_ReturnValue_1;    // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1717[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UUMGSequencePlayer*                    CallFunc_CreatePlayAnimationTimeRangeProxyObject_Result; // 0x50(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimationPlayCallbackProxy*     CallFunc_CreatePlayAnimationTimeRangeProxyObject_ReturnValue; // 0x58(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_CustomEvent_Visiable;                       // 0x81(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_171B[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	double                                       CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast_1; // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_CreatePlayAnimationTimeRangeProxyObject_PlaybackSpeed_ImplicitCast; // 0xA0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
