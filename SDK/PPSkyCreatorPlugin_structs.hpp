...
{
public:
	struct FPPSkyCreatorSkyAtmosphereSettings    SkyAtmosphereSettings;                             // 0x0(0x80)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FPPSkyCreatorVolumetricCloudSettings  VolumetricCloudSettings;                           // 0x80(0xA8)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FPPSkyCreatorBackgroundCloudSettings  BackgroundCloudSettings;                           // 0x128(0x24)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FPPSkyCreatorSkyLightSettings         SkyLightSettings;                                  // 0x14C(0x2C)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FPPSkyCreatorSunLightSettings         SunLightSettings;                                  // 0x178(0x48)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FPPSkyCreatorPostProcessSettings      PostProcessSettings;                               // 0x44C(0xC)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
};
