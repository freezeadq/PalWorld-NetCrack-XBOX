...
{
public:
	uint8                                        Pad_19EA[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19ED[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19EE[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19FB[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1A00[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
