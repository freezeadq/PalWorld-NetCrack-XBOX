...
public:
	...
	uint8                                        Pad_271B[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_271C[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_271E[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2722[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
