...
struct ABP_GliderObjectBase_C_ExecuteUbergraph_BP_GliderObjectBase_Params
{
public:
	...
	class UPalGliderComponent*                   CallFunc_GetComponentByClass_ReturnValue;          // 0x20(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
