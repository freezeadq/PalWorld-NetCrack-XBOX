...
{
public:
	uint8                                        Pad_FAC[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_FB3[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FCA[0x35];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FCB[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_FD0[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
