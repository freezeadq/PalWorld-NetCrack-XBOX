...
{
public:
	uint8                                        Pad_22FF[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2302[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2312[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2317[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_234E[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_234F[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2361[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
