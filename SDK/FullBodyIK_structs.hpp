...
public:
	...
	uint8                                        Pad_26FF[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2707[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2709[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_270A[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
