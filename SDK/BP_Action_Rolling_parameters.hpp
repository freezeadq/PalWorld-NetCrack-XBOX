...
struct UBP_Action_Rolling_C_ExecuteUbergraph_BP_Action_Rolling_Params
{
public:
	...
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_3;         // 0x20(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_4;         // 0x30(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_5;         // 0x50(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetActionVelocity_ReturnValue;            // 0x58(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x70(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor)
