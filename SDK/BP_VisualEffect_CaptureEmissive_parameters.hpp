...
struct UBP_VisualEffect_CaptureEmissive_C_TickVisualEffect_Params
{
public:
...
struct UBP_VisualEffect_CaptureEmissive_C_ExecuteUbergraph_BP_VisualEffect_CaptureEmissive_Params
{
public:
	...
	TArray<class UMaterialInstanceDynamic*>      CallFunc_GetMainMeshMaterials_ReturnValue_1;       // 0x68(0x10)(ReferenceParm)
	...
	bool                                         CallFunc_GreaterEqual_DoubleDouble_ReturnValue;    // 0x85(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_43BD[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class APalCharacter*                         CallFunc_GetCharacter_ReturnValue;                 // 0x88(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
