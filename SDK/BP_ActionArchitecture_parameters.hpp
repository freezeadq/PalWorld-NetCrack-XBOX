...
struct UBP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture_Params
{
public:
	...
	class FName                                  CallFunc_DecreaseFullStomachRate_Work_ReturnValue; // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_240E[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class ABP_ArchitectureHammer_C*              CallFunc_FinishSpawningActor_ReturnValue;          // 0xD0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_4;         // 0xD8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalShooterComponent*                  CallFunc_GetComponentByClass_ReturnValue;          // 0xE0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_5;         // 0xE8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalShooterComponent*                  CallFunc_GetComponentByClass_ReturnValue_1;        // 0xF8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                         CallFunc_GetActionCharacter_ReturnValue_6;         // 0x108(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AController*                           CallFunc_GetController_ReturnValue_1;              // 0x110(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                     K2Node_DynamicCast_AsPlayer_Controller_1;          // 0x118(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
