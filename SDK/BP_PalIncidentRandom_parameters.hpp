...
public:
	...
	uint8                                        Pad_2DB9[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPalRandomIncidentSettings            CallFunc_Get_Setting_Table_Row_Data;               // 0x8(0x28)(None)
};
...
public:
	...
	uint8                                        Pad_2DC7[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2DC9[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
