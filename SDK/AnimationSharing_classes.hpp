...
public:
	...
	uint8                                        Pad_1A58[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A5E[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A60[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A62[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A65[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A66[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A70[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
